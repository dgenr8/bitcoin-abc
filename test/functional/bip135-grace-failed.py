...
class BIP135ForksTest(ComparisonTestFramework):
    ...
    def __init__(self):
        ...
        self.fork_starttime = self.mocktime + 30        
        self.extra_args=[['-debug=all', '-whitelist=127.0.0.1']]
    ...
    def generate_blocks(self, number, version, test_blocks = []):
        for i in range(number):
            ...
            block = create_block(self.tip, create_coinbase(self.height), self.last_block_time)
    ...
    def test_BIP135GraceConditions(self):
        ...
        self.height = 1
        self.last_block_time = self.mocktime
        self.tip = int("0x" + node.getbestblockhash(), 0)
